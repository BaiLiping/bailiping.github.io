...
- **Work** lists point-target handover, extended-target tracking, density fusion,
  and joint-PDF derivations directly.
...
- `/eo-derivation/` and `/eo-derivation-slides/` contain the joint-PDF derivations and GrBP appendix.
