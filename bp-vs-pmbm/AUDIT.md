...
The slide deck was redesigned on September 18, 2026 into 17 slides with three
introduction/live pairs. The numerical solver and benchmark values below remain
unchanged. Current build and browser checks are documented in
`../bp-vs-pmbm-slides/README.md`; the original 19-slide description below records
the earlier mathematical audit.
