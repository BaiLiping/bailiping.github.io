(() => {
  ...
  const COLORS = ['#496e87', '#b16f35', '#2f7b67', '#75638f', '#a45569', '#0694a2', '#65a30d']
  ...
  const OBJECTS = [
    { x: 32, y: 45.2, rx: 9, ry: 5, angle: -12, color: '#496e87', label: 'object 1' },
    { x: 63.5, y: 51, rx: 8.5, ry: 4.6, angle: 15, color: '#b16f35', label: 'object 2' }
  ]
  ...
  function grid(svg, width, height) {
    ...
    svgElement('path', { d: 'M36 0H0V36', fill: 'none', stroke: '#d8ded7', 'stroke-width': 1 }, pattern)
    svgElement('rect', { x: 1, y: 1, width: width - 2, height: height - 2, rx: 12, fill: '#fdfdfb', stroke: '#d8ded7' }, svg)
  ...
  function renderMarginals() {
    const categories = [
      ['m₉ from object 2', 'object 2', '#b16f35'],
      ['m₉ from object 1', 'object 1', '#496e87'],
      ['m₉ births new object', 'new object', '#2f7b67'],
  ...
  function renderGibbs() {
    ...
    if (state.gibbs.last !== null) {
      ...
      svgElement('circle', { cx: point.x, cy: point.y, r: 12, fill: 'none', stroke: '#203129', 'stroke-width': 2 }, elements.gibbsScene)
    }
  ...
  function renderBp() {
    ...
    const rows = [
      ['object 1 existence', state.bp.existence[0], '#496e87'],
      ['object 2 existence', state.bp.existence[1], '#b16f35'],
      ['m₉ → object 1', state.bp.probabilities[8][0], '#496e87'],
      ['m₉ → object 2', state.bp.probabilities[8][1], '#b16f35'],
