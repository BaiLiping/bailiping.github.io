...
slides.push(regular(
  ...
  [
    ...
    line('route-double-a-glow', 880, 299, 1000, 370, '#6D28D9', 15, { opacity: .28 }),
    line('route-double-b-glow', 1000, 370, 1115, 316, '#6D28D9', 15, { opacity: .28 }),
    line('route-double-c-glow', 1115, 316, 1090, 331, '#6D28D9', 15, { opacity: .28 }),
    ...
    line('route-double-a-outline', 880, 299, 1000, 370, C.paper, 9, { opacity: .92 }),
    line('route-double-b-outline', 1000, 370, 1115, 316, C.paper, 9, { opacity: .92 }),
    line('route-double-c-outline', 1115, 316, 1090, 331, C.paper, 9, { opacity: .92 }),
    line('route-double-a', 880, 299, 1000, 370, '#6D28D9', 5),
    line('route-double-b', 1000, 370, 1115, 316, '#6D28D9', 5),
    line('route-double-c', 1115, 316, 1090, 331, '#6D28D9', 5),
    shape('route-single-point', 975, 273, 10, 10, C.paper, { shape: 'ellipse', stroke: C.map, strokeWidth: 3 }),
    shape('route-double-point-a', 993, 363, 14, 14, C.paper, { shape: 'ellipse', stroke: '#6D28D9', strokeWidth: 4 }),
    shape('route-double-point-b', 1108, 309, 14, 14, C.paper, { shape: 'ellipse', stroke: '#6D28D9', strokeWidth: 4 }),
    ...
    line('route-legend-double', 1032, 502, 1052, 502, '#6D28D9', 5),
    text('route-legend-double-v', 1059, 494, 82, 18, '2 bounces', 10, { color: '#6D28D9', fontFamily: MONO, fontWeight: 700 }),
