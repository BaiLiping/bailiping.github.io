...
slides.push(regular(
  ...
  [
    ...
    image(
      ...
      {
        fit: 'contain',
        alt: 'Frameless oblique 3D scene with a base-station antenna, green user equipment positioned along the right wall, and direct, one-bounce, and two-bounce radio routes.',
        fx: { enter: 'fade-up', order: 2 }
      }
    ),
    line('route-los-glow', 883, 296, 1095, 304, C.measurement, 9, { opacity: .18 }),
    line('route-single-a-glow', 881, 292, 980, 278, C.map, 9, { opacity: .18 }),
    line('route-single-b-glow', 980, 278, 1095, 302, C.map, 9, { opacity: .18 }),
    line('route-double-a-glow', 880, 299, 1000, 370, C.known, 9, { opacity: .18 }),
    line('route-double-b-glow', 1000, 370, 1060, 274, C.known, 9, { opacity: .18 }),
    line('route-double-c-glow', 1060, 274, 1095, 306, C.known, 9, { opacity: .18 }),
    line('route-los', 883, 296, 1095, 304, C.measurement, 3),
    line('route-single-a', 881, 292, 980, 278, C.map, 3),
    line('route-single-b', 980, 278, 1095, 302, C.map, 3),
    line('route-double-a', 880, 299, 1000, 370, C.known, 3),
    line('route-double-b', 1000, 370, 1060, 274, C.known, 3),
    line('route-double-c', 1060, 274, 1095, 306, C.known, 3),
    ...
    shape('route-double-point-b', 1055, 269, 10, 10, C.paper, { shape: 'ellipse', stroke: C.known, strokeWidth: 3 }),
    text('route-bs-label', 812, 272, 54, 18, 'BS', 10, { color: C.ink, fontFamily: MONO, fontWeight: 700, align: 'right' }),
    text('route-ue-label', 1101, 307, 44, 18, 'UE', 10, { color: C.ue, fontFamily: MONO, fontWeight: 700 }),
