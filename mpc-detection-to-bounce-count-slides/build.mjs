...
slides.push(regular(
  ...
  [
    ...
    image(
      ...
      {
        fit: 'contain',
        alt: 'Frameless oblique 3D scene with a base-station antenna, green user equipment standing on the floor near the right wall, and direct, one-bounce, and two-bounce radio routes.',
        fx: { enter: 'fade-up', order: 2 }
      }
    ),
    line('route-los-glow', 883, 296, 1061, 315, C.measurement, 9, { opacity: .18 }),
    line('route-single-a-glow', 881, 292, 980, 278, C.map, 9, { opacity: .18 }),
    line('route-single-b-glow', 980, 278, 1061, 313, C.map, 9, { opacity: .18 }),
    line('route-double-a-glow', 880, 299, 1000, 370, C.known, 9, { opacity: .18 }),
    line('route-double-b-glow', 1000, 370, 1090, 286, C.known, 9, { opacity: .18 }),
    line('route-double-c-glow', 1090, 286, 1061, 317, C.known, 9, { opacity: .18 }),
    line('route-los', 883, 296, 1061, 315, C.measurement, 3),
    line('route-single-a', 881, 292, 980, 278, C.map, 3),
    line('route-single-b', 980, 278, 1061, 313, C.map, 3),
    line('route-double-a', 880, 299, 1000, 370, C.known, 3),
    line('route-double-b', 1000, 370, 1090, 286, C.known, 3),
    line('route-double-c', 1090, 286, 1061, 317, C.known, 3),
    ...
    shape('route-double-point-b', 1085, 281, 10, 10, C.paper, { shape: 'ellipse', stroke: C.known, strokeWidth: 3 }),
