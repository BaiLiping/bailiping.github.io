(() => {
  ...
  function mountEquivalence() {
    const shell = createShell({
      ...
      stageBody: `
        <div class="eq-layout">
          <p class="review-numerics-note">${mathHtml(String.raw`P_s=(P+P^\mathsf{T})/2`)}. QR symmetry is enforced by mirroring. ${mathHtml(String.raw`\Delta`)} is the largest entrywise difference across the toy mean and covariance.</p>
