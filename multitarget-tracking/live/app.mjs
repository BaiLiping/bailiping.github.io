...
picture.addEventListener('error',()=>{document.querySelector('#status').textContent='Image unavailable. Try another sequence or reload the page.'});
render();
